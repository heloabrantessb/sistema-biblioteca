...
<x-app-layout>
    <div class="flex min-h-screen bg-gray-100">
        ...
        <aside class="w-64 bg-blue-900 text-white p-6">
            <h2 class="text-xl font-semibold mb-6">Categorias</h2>
            <nav>
                <ul>
                    <li class="mb-4">
                        <a href="{{ route('categorias.create') }}"
                            class="block py-2 px-4 bg-sky-600 hover:bg-sky-700 rounded">Adicionar
                            Categoria</a>
                    </li>
                    <li class="mb-4">
        ...
        <main class="overflow-x-auto rounded-xl border shadow-sm bg-card w-full p-12 pb-6 min-h-screen">
            ...
            @endif
            <div class="flex items-center justify-between m-auto pb-8 w-1/3 align-center">
