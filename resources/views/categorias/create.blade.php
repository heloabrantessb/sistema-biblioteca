...
<x-app-layout>
    <div class="m-8 flex items-center justify-center flex-col">
        ...
        <h1 class='text-3xl font-semibold text-gray-800 mb-2'>Nova Categoria</h1>
        <p class="mb-6 text-gray-500">Adicione uma nova categoria</p>

        <form action="{{ route('categorias.store') }}" method="POST" class="bg-white shadow-md rounded-xl p-10 w-full max-w-lg space-y-6">
            @csrf
